...
<!--{elseif $type==3}-->
		...
		<p class="a-r">
			<span><img src="style/down.gif"/><span id="op_<?=$id?>"><a href="javascript:void(0)"  onclick="oppose_comment(<?=$id?>);">{lang commentOppose}</a></span>(<span id="o_<?=$id?>"><?=$comments['oppose']?></span>)</span>
			<span><img src="style/up.gif"/><span id="ae_<?=$id?>"><a href="javascript:void(0)"  onclick="aegis_comment(<?=$id?>);" >{lang commentAegis}</a></span>(<span id="a_<?=$id?>"><?=$comments['aegis']?></span>)</span>
			<span><img src="style/reply.gif"/><a href="javascript:void(0)"  onclick="reply_comment(<?=$id?>);">{lang commentReply}</a></span>
			<span><img src="style/jubao.gif"/><a href="javascript:void(0)"  onclick="report_comment(<?=$id?>);">{lang commentReport}</a></span>
			<!--{if $commentEdit}-->
			<span><img src="style/ament.gif"/><a href="javascript:void(0)"  onclick="edit_comment(<?=$id?>);">{lang commentEdit}</a></span>
			<span><img src="style/delete.gif"/><a href="javascript:void(0)"  onclick="del_comment(<?=$id?>);">{lang commentDel}</a></span>
			<!--{/if}-->
		</p>
		</div>
<!--{/if}-->
